...
function M.on_attach(client, buffer)
  ...
  self:map("<leader>lwa", vim.lsp.buf.add_workspace_folder, { desc = "Workspace" })
  self:map("<leader>lwr", vim.lsp.buf.remove_workspace_folder, { desc = "Workspace" })
  self:map("<leader>lwl", function()
    vim.notify(vim.inspect(vim.lsp.buf.list_workspace_folders()), "info", { title = "Workspace" })
  end, { desc = "Workspace" })
