...
-- map("n", "<C-q>", "<C-w><C-q>", opts)
map("n", "sq", "<C-w><C-q>", opts)
-- map("n", "<C-s>", ":split<Return>", opts)
-- map("n", "<C-v>", ":vsplit<Return>", opts)
...
map("v", "<A-j>", ":m .+1<CR>==", { desc = "Move down" })
map("v", "<A-k>", ":m .-2<CR>==", { desc = "Move up" })
map("v", "p", '"_dP', opts)
